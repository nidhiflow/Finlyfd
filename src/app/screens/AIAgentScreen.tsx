...
export function AIAgentScreen() {
  ...
  return (
    <PremiumFeatureGate
      featureName="AI Financial Coach"
      requiredTier="Premium"
      benefits={[
        "Ask questions & get personalized financial coaching",
        "Scan receipts and auto-extract items in real-time",
        "Generate optimized budget plans & spending alerts",
        "Deep analyze cash flow patterns with visual graphs"
      ]}
    >
