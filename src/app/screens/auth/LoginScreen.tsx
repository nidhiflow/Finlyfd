        ...
        <>
          ...
          <div className="space-y-4 flex-1">
            ...
            <button
              ...
              className="w-full py-4 bg-[var(--surface)] border border-ink/10 rounded-xl text-ink font-semibold hover:border-ink/20 transition-colors flex items-center justify-center gap-3">
