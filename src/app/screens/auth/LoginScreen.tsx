        ...
        <>
          ...
          <div className="space-y-4 flex-1">
            ...
            <button
              ...
              className="w-full py-4 bg-[#1B2130] border border-white/10 rounded-xl text-white font-semibold hover:border-white/20 transition-colors flex items-center justify-center gap-3">
