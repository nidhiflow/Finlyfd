  ...
  return (
    <PremiumFeatureGate
      ...
      benefits={[
        ...
        "Forecast long term compound growth with visual graphs",
        "Model custom interest/returns percentages up to 25%",
        "Toggle starting capital & monthly contribution logic"
      ]}
    >
